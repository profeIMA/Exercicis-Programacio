...
//Post: pila.vec[0..pila.n_cartes-1] conté una permutacié ordenada dels valors de VEC[0..pila.n_cartes-1]
...
//Pre: 0<=pila.n_cartes<=N_MAX
//Post: pila.vec[0..pila.n_cartes-1] conté successivament les cartes entrades
...
//Pre: 0<=pila.n_cartes<=N_MAX
//Post: s'han mostrat les pila.n_cartes cartes de cartes.vec
	for (int i = 0; i < cartes.n_cartes; i++) {
...
int main() {
	...
	cout << "Introduir n�mero de cartes: ";
	cin >> cartes.n_cartes;
