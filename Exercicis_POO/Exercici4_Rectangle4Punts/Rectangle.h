...
private:
// Atributs
    Punt2D a;     // composició, vèrtex inferior esquerra
    Punt2D b;     // composició, vèrtex superior esquerra
    Punt2D c;     // composició, vèrtex superior dret
    Punt2D d;     // composició, vèrtex inferior dret
