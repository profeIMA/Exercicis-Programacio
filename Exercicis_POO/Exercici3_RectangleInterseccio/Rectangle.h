...
// Consultors
    ...
    void interseccio(Rectangle r, Rectangle &inter, bool &hi_ha_inter) const;
    // Pre: --; Post: si hi ha intersecció entre actual i r, hi_hi_inter és cert i, en cas contrari, és fals; en el cas que hi hagi interseccció, inter és el rectangle interseccció
